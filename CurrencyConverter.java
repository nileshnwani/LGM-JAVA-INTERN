...
import java.applet.*;
/*<applet code="CurrencyConverter" width=500 height=600> </applet>*/
public class CurrencyConverter extends Applet{
    ...
    public static void converter()
    {
        ...
        b1 = new JButton("INR");
        b1.setBounds(80, 80, 80, 20);
        b2 = new JButton("Dollar");
        b2.setBounds(240,80, 80,20);
